...
http.createServer((req, res)=>{
    ...
    // 응답 내용의 마지막 전송 : res.end 실행후에는 더 이상 응답내용이
    // 전송될 수 없습니다
    res.end('<p>Hello Server #1!</p>');
}).listen(8081, ()=>{ // 포트번호와 함께 이벤트 리스너 설정
    console.log('8081번 포트에서 서버 대기중입니다!');
});
// req, res : request, response의 의미를 갖는 변수입니다
// 매개변수고, 서버에 있는 실제 request, response객체가 전달됩니다
// 매개변수는 그 객체를 전달받아 사용하는 것으로 변수의 이름은 자유롭게
// 변경이 가능합니다. 다만 함수 내에서 변경된 이름을 일관되게 사용해주는 것이
// 중요합니다
