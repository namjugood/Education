...
<table>
	...
	<tr><td>
		...
		<input type="button" value="회원정보변경" onClick="location.href=
											'member.do?command=update_form' ">
		<input type="button" value="회원탈퇴" onClick="location.href=
											'member.do?command=delete&userid=${loginUser.userid}'">
		<c:if test="${loginUser.admin==1}">
			<input type="button" value="멤버보기" onClick="location.href='member.do?command=select_all'">
